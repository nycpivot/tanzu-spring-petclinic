...
```
tanzu apps workload create tanzu-spring-petclinic -f config/workload.yaml \
  --local-path . \
  --source-image <REPOSITORY-PREFIX>/tanzu-spring-petclinic-source \
  --type web
```
...
```
tanzu apps workload get tanzu-spring-petclinic
```
