...
```json
{
  ...
  "projectName" : "tanzu-spring-petclinic"
}
```
## Log
```
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [spring-petclinic->tanzu-spring-petclin...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: spring-petclinic->: tanzu-spring-petcl...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [spring-petclinic template repo->tanzu-spring-petclin...(truncated)]
